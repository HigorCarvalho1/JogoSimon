...
//                 sequencia = 1;
//                 fase1()
//                 setTimeout(fase11, 800)
//                 listamaquina.push(image[0].dataset.action)
//                 console.log(listamaquina)
//                 caixas.addEventListener('click', (event)=>{
//                     contadordeclicks ++
//                     if(contadordeclicks == 1){
//                         listajogador.push(event.target.dataset.action)
//                         console.log(listajogador)
//                         if(listajogador[0] == listamaquina[0]){
//                             contadordeclicks = 0
//                             listajogador = []
//                             listamaquina = []
//                             console.log('deu certo')
//                         }else  if (listajogador[0] != listamaquina[0]){
//                             sequencia = 0
//                             contadordeclicks = 0
//                             listajogador = []
//                             listamaquina = []
...
//                     fase1()
//                     setTimeout(fase11, 800)
//                     setTimeout(fase2, 1600)
//                     setTimeout(fase22, 2400)
//                     listamaquina.push(image[0].dataset.action)
//                     listamaquina.push(image[1].dataset.action)
//                     caixas.addEventListener('click', (event)=>{
//                         contadordeclicks++
